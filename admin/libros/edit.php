...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Actualizacion del libro</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->

            <div class="card">
                <div class="card-header" style="background-color:#008000; color:#ffffff">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php  echo $numero; ?>" >
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for=""> No. Ficha</label>
                                <input type="text" class="form-control" value="<?php  echo $ficha; ?>" >
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php  echo $ejemplares; ?>" >
                            </div>
                        </div>
                        <div class="col-md-10">
                        <div class="form-group">
                                <label for="">Observaciones</label><span style="color: red;"> <b>*</b></span>
                                <input type="text" class="form-control" value="<?php  echo $observaciones; ?>" >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               <center>
                                   <button type="submit" onclick="return confirm('Asegurece de llenar la información correcta');" class="btn btn-success btn-block">Actualizar libro</button>
                               </center>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
